...
| 6. Formularios y plantillas | 8 % | 92 % | 7,36 % | Asignación explícita, diez plantillas, calidad, borrador separado, revisión independiente, aprobación, publicación inmutable, control de concurrencia y archivado recuperable | Traducciones y biblioteca validada por dominios/países |
...
| 9. QA y piloto | 6 % | 74 % | 4,44 % | 48 pruebas automatizadas, build/lint, E2E Supabase y territorial transaccional, dependencias, encabezados, carga y QA accesible/responsive | Dispositivos Android físicos, auditoría WCAG/pentest externo y piloto ArcGIS institucional |
...
- Suite local aprobada: 48/48 pruebas, lint, validación sintáctica ArcGIS, TypeScript/Vite/PWA y 269 tareas Gradle con pruebas unitarias y compilación Android sin fallos.
...
- APK de prueba 2.12.0 generado con `versionCode 16`, `minSdk 23`, SDK objetivo 35 y SHA-256 `fe429e563acb045ba4bcd348a94cca77e0ed443e1ac9e5eb318fdfc12f014587`.
